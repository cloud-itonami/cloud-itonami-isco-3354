...
This project handles government licensing officials' operating workflows.
...
- credential exposure
- real applicant or office data exposure
- authorization bypass
- Licensing Coordination Governor bypass
- audit-ledger tampering
- over-disclosure in reports or exports
- unsafe robot action dispatch
- any path that issues, denies, renews or revokes a license or permit
  without a human licensing official's decision
...
- Keep real applicant/office data outside this repository.
